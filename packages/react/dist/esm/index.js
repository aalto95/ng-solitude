...
var Slider = function (_a) {
    ...
    var _b = useState(0), currentSlideId = _b[0], setCurrentSlideId = _b[1];
    var _c = useState(''), slideDirection = _c[0], setSlideDirection = _c[1];
    var _d = useState(1), downX = _d[0], setDownX = _d[1];
    var _e = useState(1), upX = _e[0], setUpX = _e[1];
    ...
    return (React.createElement("div", { className: "container", onMouseDown: function (e) { return listenToMouseDown(e); }, onMouseUp: function (e) { return listenToMouseUp(e); }, onTouchStart: (function (e) { return listenToTouchStart(e); }), onTouchEnd: (function (e) { return listenToTouchEnd(e); }) },
        React.createElement("div", { className: "slider" },
            slides.map(function (slide, idx) { return (React.createElement("div", { key: slide.image, style: { backgroundImage: "url(".concat(slide.image, ")") }, className: "slide ".concat(currentSlideId === idx ? '' : slideDirection === 'right' ? 'hideToLeft' : 'hideToRight') },
                React.createElement("h1", null, slide.label),
                React.createElement("p", null, slide.paragraph))); }),
            React.createElement("button", { className: "slideButton", onClick: slideLeft },
                React.createElement("img", { src: img, alt: "left", className: "arrow" })),
            React.createElement("div", { className: "middleSection", id: "slider" }, slides.map(function (slide, id) { return (React.createElement("div", { key: id, className: "circle ".concat(id === currentSlideId ? 'current' : '') })); })),
            React.createElement("button", { className: "slideButton", onClick: slideRight },
                React.createElement("img", { src: img$1, alt: "right", className: "arrow" })))));
};
